...
class TestUser(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        """
        self.assertTrue(len(getdoc(user)) > 0, "Missing module docs")
        self.assertTrue(len(getdoc(User)) > 0, "Missing class docs")
        for _, fn in getmembers(User, isfunction):
    ...
    def test_str(self):
        ...
        self.maxDiff = None
        self.assertEqual(str(self.m0), "[User] ({}) {}"
