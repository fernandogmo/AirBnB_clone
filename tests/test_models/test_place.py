...
class TestPlace(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        """
        self.assertTrue(len(getdoc(place)) > 0, "Missing module docs")
        self.assertTrue(len(getdoc(Place)) > 0, "Missing class docs")
        for _, fn in getmembers(Place, isfunction):
    ...
    def test_str(self):
        ...
        self.maxDiff = None
        self.assertEqual(str(self.m0), "[Place] ({}) {}"
