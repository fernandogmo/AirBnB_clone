...
class TestCity(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        """
        self.assertTrue(len(getdoc(city)) > 0, "Missing module docs")
        self.assertTrue(len(getdoc(City)) > 0, "Missing class docs")
        for _, fn in getmembers(City, isfunction):
    ...
    def test_pep8(self):
        ...
        """
        file_msgs = [('models/city.py',
                      'Found code style errors in city.py.'),
                     ('tests/test_models/test_city.py',
                      'Found code style errors in test_city.py.')]
    ...
    def test_str(self):
        ...
        self.maxDiff = None
        self.assertEqual(str(self.m0), "[City] ({}) {}"
