...
class TestState(unittest.TestCase):
    ...
    def test_docstring(self):
        ...
        """
        self.assertTrue(len(getdoc(state)) > 0, "Missing module docs")
        self.assertTrue(len(getdoc(State)) > 0, "Missing class docs")
        for _, fn in getmembers(State, isfunction):
    ...
    def test_pep8(self):
        ...
        """
        file_msgs = [('models/state.py',
                      'Found code style errors in state.py.'),
                     ('tests/test_models/test_state.py',
                      'Found code style errors in test_state.py.')]
    ...
    def test_str(self):
        ...
        self.maxDiff = None
        self.assertEqual(str(self.m0), "[State] ({}) {}"
